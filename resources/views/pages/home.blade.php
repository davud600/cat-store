        ...
        <div class="flex flex-col gap-10 md:gap-20 mt-12 md:mt-0">
            <div class="flex flex-row gap-24 justify-center">
                <div class="hover:scale-110 transition-all duration-300 bg-yellow-300 flex justify-center items-center rounded-xl w-14 h-14 md:w-24 md:h-24 drop-shadow-lg">
                    <svg class="fill-white md:w-14 w-10" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"><!--! Font Awesome Pro 6.3.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                ...
                <div class="hover:scale-110 transition-all duration-300 bg-sky-300 flex justify-center items-center rounded-xl w-14 h-14 md:w-24 md:h-24 drop-shadow-lg">
                    <svg class="fill-white md:w-14 w-10" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--! Font Awesome Pro 6.3.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
            ...
            <div class="flex flex-row gap-14">
                <div class="hover:scale-110 transition-all duration-300 bg-orange-300 flex justify-center items-center rounded-xl w-14 md:w-24 md:h-24 drop-shadow-lg">
                    <svg class="fill-white md:w-14 w-10" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--! Font Awesome Pro 6.3.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                ...
                <div class="md:w-36 w-10">
                    <svg class="fill-pink-300 md:w-36 w-10" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--! Font Awesome Pro 6.3.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                ...
                <div class="hover:scale-110 transition-all duration-300 bg-green-300 flex justify-center items-center rounded-xl w-14 md:w-24 md:h-24 drop-shadow-lg">
                    <svg class="fill-white w-8 md:w-12" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!--! Font Awesome Pro 6.3.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
