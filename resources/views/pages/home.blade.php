...
<section id="hero-section" class="md:px-16 px-6">
    <div class="p-2">
        ...
        <div class="w-full flex justify-center my-4 md:my-10 md:px-16 px-6 text-center">
            <h1 class="md:text-4xl text-3xl font-bold text-white">There are many reasons why you should get a cat: </h1>
        </div>
        ...
        <a class="prev cursor-pointer absolute left-0 top-1/2 w-auto -mt-14 p-8 text-blue-600 font-black drop-shadow-xl text-4xl transition-all hover:text-blue-700" onclick="plusSlides(-1)">&#10094;</a>
        <a class="next cursor-pointer absolute right-0 top-1/2 w-auto -mt-14 p-8 text-blue-600 font-black drop-shadow-xl text-4xl transition-all hover:text-blue-700" onclick="plusSlides(1)">&#10095;</a>

        <!-- The dots/circles -->
        <div style="text-align:center">
            <span class="dot cursor-pointer h-3 w-3 mx-0 my-2 bg-neutral-700 rounded-full inline-block transition-all" onclick="currentSlide(1)"></span>
            <span class="dot cursor-pointer h-3 w-3 mx-0 my-2 bg-neutral-700 rounded-full inline-block transition-all" onclick="currentSlide(2)"></span>
            <span class="dot cursor-pointer h-3 w-3 mx-0 my-2 bg-neutral-700 rounded-full inline-block transition-all" onclick="currentSlide(3)"></span>
        </div>
    </div>
</section>
<section id="buy-section">
    <div class="bg-black flex px-16 py-10 md:h-96 flex-col md:flex-row" style="height: 32rem;">
        <div class="flex flex-col md:w-1/2 w-full gap-6 text-center justify-center">
            <span class="md:text-3xl text-2xl font-bold text-white">Buy any kind of cat you want</span>
            <form action="/cats" method="get">
                <input name="searchQuery" id="searchQuery" type="text" placeholder="Search for any cat breed" class="text-white nosubmit border-red-600 bg-transparent border-solid border-2 rounded-2xl py-3 md:py-4 md:w-72 w-52 text-sm md:text-base md:pl-9 pl-7 pr-2 md:pr-3">
            </form>
        </div>
        <div class="flex flex-col gap-10 md:gap-20 mt-12 md:mt-0">
            <div class="flex flex-row gap-24 justify-center">
                <div class="hover:scale-110 transition-all duration-300 bg-yellow-500 opacity-90 flex justify-center items-center rounded-xl w-14 h-14 md:w-24 md:h-24 drop-shadow-lg">
                ...
                <div class="hover:scale-110 transition-all duration-300 bg-sky-500 opacity-90 flex justify-center items-center rounded-xl w-14 h-14 md:w-24 md:h-24 drop-shadow-lg">
            ...
            <div class="flex gap-14">
                <div class="hover:scale-110 transition-all duration-300 bg-orange-500 opacity-90 flex justify-center items-center rounded-xl w-14 md:w-24 md:h-24 drop-shadow-lg h-14">
                    <svg class="fill-white md:w-14 w-8" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--! Font Awesome Pro 6.3.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                ...
                <div class="md:w-36 w-10 md:block hidden">
                    <svg class="fill-pink-500 md:w-36 w-8" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--! Font Awesome Pro 6.3.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                ...
                <div class="hover:scale-110 transition-all duration-300 bg-green-500 opacity-90 flex justify-center items-center rounded-xl w-14 md:w-24 md:h-24 drop-shadow-lg">
    ...
    <div class="flex justify-center px-16 mb-6">
