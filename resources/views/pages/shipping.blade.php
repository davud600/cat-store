...
<section id="shipping-section" class="px-4 md:px-14 py-12">
    <article class="flex flex-col items-center text-center gap-4 bg-gray-200 px-4 md:px-6 py-8 rounded-lg">
        ...
        <form class="w-5/6 md:w-2/3 my-4 flex flex-col gap-6" action="/save-shipping-info" method="post">
            ...
            <input id="address2" name="address2" class="w-full text-base md:text-lg pl-5 pr-3 rounded-lg py-2 text-gray-700" type="text" placeholder="Street Address Line 2 (optional)">
            <div class="flex flex-col md:flex-row gap-4">
            ...
            <input class="text-center cursor-pointer bg-red-600 w-full md:w-48 py-3 px-1 text-white rounded-lg font-bold my-4 hover:bg-red-800 transition-all" type="submit">
        </form>
    </article>
</section>
@endsection