...
<section id="shipping-section" class="px-4 md:px-14 py-12">
    <article class="flex flex-col items-center text-center gap-4 bg-neutral-800 px-4 md:px-6 py-8 rounded-lg">
        <h1 class="text-2xl md:text-3xl font-bold my-4 text-white">Your order has been received</h1>
        <!-- <div class=""> -->
        ...
        <!-- </div> -->
        <h2 class="text-xl md:text-2xl text-neutral-200">Thank you for your purchase!</h2>
        <span class="text-base md:text-lg text-neutral-300">Your order ID is: 1234567890</span>
